-- ============================================
-- SIMPLE DATABASE SETUP (NO PROBLEMATIC TRIGGERS)
-- ============================================
-- This version skips the auto-profile-creation trigger
-- to avoid errors with existing users
-- ============================================
...
-- ============================================
-- Note: Profile creation on signup is handled by the app, not by triggers
