-- ============================================================================
-- MASTER MIGRATION: Fix All Critical Issues
-- ============================================================================
-- This migration must be run first before other migrations
-- It fixes all critical database issues in the correct order:
-- 1. Add POPIA consent fields
...
-- PODCAST COMMENTS (THIS FIXES THE ERROR YOU'RE SEEING)
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
...
-- 2. ✅ Created all necessary foreign key relationships
...
-- 5. ✅ Fixed podcast comments foreign key (fixes "Could not find relationship" error)
-- 6. ✅ Granted necessary permissions to authenticated users
-- ============================================================================
