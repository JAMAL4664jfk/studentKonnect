...
// Sample accommodations data as fallback
const SAMPLE_ACCOMMODATIONS: Accommodation[] = [
  {
    id: 1,
    userId: "sample-user",
    title: "Modern Studio Apartment",
    description: "Cozy studio perfect for students, close to campus with all amenities included",
  ...
  },
  {
    ...
    description: "Affordable shared accommodation near Wits University with friendly housemates",
  ...
  },
  {
    ...
    description: "Spacious 2-bedroom apartment with secure parking and 24/7 security",
    address: "78 Empire Rd",
    city: "Johannesburg",
    country: "South Africa",
    price: "6000",
    currency: "ZAR",
    ...
    bedrooms: 2,
    bathrooms: 1,
    amenities: '["WiFi", "Parking", "Security", "Furnished", "Balcony"]',
  ...
  },
  {
    ...
    description: "Friendly house share with 4 students, great community vibe and garden space",
    address: "12 Rockey St",
    city: "Johannesburg",
    country: "South Africa",
    price: "2800",
    currency: "ZAR",
    ...
    bedrooms: 1,
    bathrooms: 2,
    amenities: '["WiFi", "Garden", "Shared Kitchen", "BBQ Area"]',
  ...
  },
  {
    id: 5,
    userId: "sample-user",
    title: "Campus Dormitory Room",
    description: "On-campus accommodation with meal plan included and study facilities",
    address: "West Campus",
    city: "Johannesburg",
    country: "South Africa",
    price: "4200",
    ...
    bedrooms: 1,
    bathrooms: 1,
    amenities: '["WiFi", "Meal Plan", "24/7 Security", "Study Room", "Gym Access"]',
  ...
  const fetchAccommodations = async () => {
    try {
      ...
      if (!data || data.length === 0) {
        console.log("[ACCOMMODATION] No data from database, using sample data");
        setAccommodations(SAMPLE_ACCOMMODATIONS);
        Toast.show({
          type: "info",
          text1: "Sample Data",
          text2: "Showing sample accommodations",
        });
      } else {
